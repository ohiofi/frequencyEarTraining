...
<title>Ear Training web app</title>
...
<div id="main">
  <div id="header">
    <h1>Ear Training, Level 3</h1>
  </div>
  <div class="tutorsplitter">
  <div id="video">
  		<img src="img/eartraining2tutor.png" width="450px"/>
  	</div>
  <p>How to play: Click the Play button to hear a tone, then click the button that matches the frequency/frequency range.</p>
  </div>
  <div class="tutorsplitter">
  ...
  <div id="gobackorcontinue" class="centered">
    ...
    <a href="eartraining3.php"><div class="button gobackorcontinue">
