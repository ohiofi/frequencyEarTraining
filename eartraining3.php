...
if (isset($_SESSION['MM_Username'])) {
  $colname_rsGame9 = $_SESSION['MM_Username'];
}
mysql_select_db($database_ohiofi, $ohiofi);
$query_rsGame9=sprintf("SELECT game9responses.entryNumber, game9responses.questionNumber FROM game9responses WHERE userName=%s AND game9responses.tally=1 ORDER BY game9responses.questionNumber DESC",
  GetSQLValueString($colname_rsGame9, "text")); 
$rsGame9 = mysql_query($query_rsGame9, $ohiofi) or die(mysql_error());
$row_rsGame9 = mysql_fetch_assoc($rsGame9);
$totalRows_rsGame9 = mysql_num_rows($rsGame9);




mysql_select_db($database_ohiofi, $ohiofi);
$query_rsScore3=sprintf("SELECT game9responses.entryNumber, game9responses.questionNumber FROM game9responses WHERE userName=%s",
  GetSQLValueString($colname_rsGame9, "text")); 
...
/* ------------------------------------- rsGame9_check is the fail safe -----------------------------------------*/

mysql_select_db($database_ohiofi, $ohiofi);
$query_rsGame9_check=sprintf("SELECT game9responses.entryNumber, game9responses.questionNumber FROM game9responses WHERE userName=%s AND game9responses.questionNumber=%s",
  GetSQLValueString($colname_rsGame9, "text"), GetSQLValueString($_POST['questionNumber'], "int")); 
$rsGame9_check = mysql_query($query_rsGame9_check, $ohiofi) or die(mysql_error());
$row_rsGame9_check = mysql_fetch_assoc($rsGame9_check);
$totalRows_rsGame9_check = mysql_num_rows($rsGame9_check);


mysql_select_db($database_ohiofi, $ohiofi);
$query_rsUser=sprintf("SELECT users.userID, users.game9 FROM users WHERE userName=%s ",
  GetSQLValueString($colname_rsGame9, "text")); 
...
mysql_select_db($database_ohiofi, $ohiofi);
$query_rsScoreboard = "SELECT userName, game9 FROM users ORDER BY game9 DESC";
...
mysql_select_db($database_ohiofi, $ohiofi);
$query_rsScoreboard = "SELECT userName, game9 FROM users WHERE game9 > 0 ORDER BY game9 DESC";
$query_limit_rsScoreboard = sprintf("%s LIMIT %d, %d", $query_rsScoreboard, $startRow_rsScoreboard, $maxRows_rsScoreboard);
$rsScoreboard = mysql_query($query_limit_rsScoreboard, $ohiofi) or die(mysql_error());
$row_rsScoreboard = mysql_fetch_assoc($rsScoreboard);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	if ($totalRows_rsGame9_check == 0) {
		  $updateSQL = sprintf("UPDATE users SET game9=%s, game9total=%s WHERE userID=%s",
							   GetSQLValueString($_POST['points'], "int"),
							   GetSQLValueString($_POST['game9total'], "int"),
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
	if ($totalRows_rsGame9_check == 0) {
		  $updateSQL = sprintf("UPDATE users SET game9total=%s WHERE userID=%s",
							   GetSQLValueString($_POST['game9total'], "int"),
							   GetSQLValueString($_POST['userNumber'], "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	if ($totalRows_rsGame9_check == 0) {
		///if ($row_rsScore3['questionNumber'] == $totalRows_rsScore3){
	  		...
	  		$insertSQL = sprintf("INSERT INTO game9responses (entryNumber, userName, questionNumber, question, answer, tally) VALUES (%s, %s, %s, %s, %s, %s)",
...
<title>Ear Training 3 web app</title>
...
<body onload="preloader(7);" />
	...
	<div id="resistorsmain">  
	    <div id="stage">
    		<div id="head1">
            Level 3, Question <?=$currentQuestion?>
            <br />
    		...
    		<div class="playButton floatLeft" onclick="gimme('400hz');" onmouseover="preloader(3);">400 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('500hz');" onmouseover="preloader(4);">500 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('600hz');" onmouseover="preloader(5);">600 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('800hz');" onmouseover="preloader(6);">800 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('1000hz');" onmouseover="preloader(7);">1000 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('1200hz');" onmouseover="preloader(8);">1200 Hz</div>
            <div class="playButton floatLeft" onclick="gimme('1600hz');" onmouseover="preloader(9);">1600 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('2000hz');" onmouseover="preloader(10);">2000 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('2400hz');" onmouseover="preloader(11);">2400 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('3200hz');" onmouseover="preloader(12);">3200 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('4000hz');" onmouseover="preloader(13);">4000 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('4800hz');" onmouseover="preloader(14);">4800 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('6400hz');" onmouseover="preloader(15);">6400 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('8000hz');" onmouseover="preloader(16);">8000 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('9600hz');" onmouseover="preloader(17);">9600 Hz</div>
            <div class="playButton floatLeft" onclick="gimme('12800hz');" onmouseover="preloader(18);">12800 Hz</div>
            <br />
    		<div class="divider">White Noise</div>
    		<div class="playButton floatLeft" onclick="gimme('whitenoise20hzto20000hz');" onmouseover="preloader(19);">20 Hz - 20000 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('whitenoise150hzto300hz');" onmouseover="preloader(20);">150 Hz - 300 Hz</div>
            <div class="playButton floatLeft" onclick="gimme('whitenoise300hzto600hz');" onmouseover="preloader(21);">300 Hz - 600 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('whitenoise600hzto1200hz');" onmouseover="preloader(22);">600 Hz - 1200 Hz</div>
            <div class="playButton floatLeft" onclick="gimme('whitenoise1200hzto2400hz');" onmouseover="preloader(23);">1200 Hz - 2400 Hz</div>
            <div class="playButton floatLeft" onclick="gimme('whitenoise2400hzto4800hz');" onmouseover="preloader(24);">2400 Hz - 4800 Hz</div>
            <div class="playButton floatLeft" onclick="gimme('whitenoise4800hzto9600hz');" onmouseover="preloader(25);">4800 Hz - 9600 Hz</div>
    		<div class="playButton floatLeft" onclick="gimme('whitenoise9600hzto19200hz');" onmouseover="preloader(26);">9600 Hz - 19200 Hz</div>
	...
	<div id="tryAgain" class="popup">
            	<h2>Incorrect</h2>
       		  <form id="form2" name="form2" action="<?php echo $editFormAction; ?>" method="POST"><input name="entryNumber" type="hidden" value="" /><input name="userName" type="hidden" value="" /><input type="hidden" name="question2" id="question2" value=""><input type="hidden" name="response2" id="response2" value=""><input name="tally" type="hidden" value="0" /><input name="questionNumber" type="hidden" value="<?php echo $currentQuestion; ?>" /><input name="userNumber" type="hidden" value="<?=$row_rsUser["userID"] ?>" /><input name="game9total" type="hidden" value="<?php echo $totalRows_rsScore3; ?>" /><input class="submit button popupbutton" type="submit" name="Submit" id="Submit" value="Continue">
                ...
                <? if ($currentQuestion % 1 == 0) { ?>
                	...
                	<h2>Your current score is<br /><? echo $row_rsUser["game9"] ?> <? if ($row_rsUser["game9"] != 1)
                                echo " pts";
                            else
                                echo " pt";
                            ?></h2>
                      ...
                      <table border="0" STYLE="margin:15px;">
                        ...
                        do { ?>
                          <tr>
                            ...
                            <td><?php echo " "; ?></td>
                            <td><?php echo " ",$row_rsScoreboard['game9'];
                            if ($row_rsScoreboard['game9'] != 1)
                                echo " pts";
                            else
                                echo " pt";
                            ?>
...
var oneChance = 0;
var youReady = 0;
var randomMP3=new Array("200hz","250hz","300hz","400hz","500hz","600hz","800hz","1000hz","1200hz","1600hz","2000hz","2400hz","3200hz","4000hz","4800hz","6400hz","8000hz","9600hz","12800hz","whitenoise20hzto20000hz","whitenoise150hzto300hz","whitenoise300hzto600hz","whitenoise600hzto1200hz","whitenoise1200hzto2400hz","whitenoise2400hzto4800hz","whitenoise4800hzto9600hz","whitenoise9600hzto19200hz");
var question=randomMP3[7];

function newQuestion() {
	var oldQuestion=question;
	question=randomMP3[(Math.floor ( ( Math.random ( ) * 27) ))];
