...
<div id="main">
  ...
  <p>How to play: Click the Play button to hear a tone, then click the EQ range that matches the frequency of the tone.</p>
  <div id="video">
  	<img src="img/signaltonestutor.png" width="500px"/>
  </div>
  <div id="gobackorcontinue" class="centered">
    <a href="mainmenu.php"><div class="button gobackorcontinue">
        <h2>Main Menu</h2>
    </div></a>
    <a href="graphiceq.php"><div class="button gobackorcontinue">
        <h2>Continue</h2>
    </div></a>
  </div>
  <br />
